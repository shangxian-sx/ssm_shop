...
<body>
	<div class="x-body layui-anim layui-anim-up">
		<form class="layui-form" action="insertChild.category" method="post">
			...
			<div class="layui-form-item">
				<label for="L_grade" class="layui-form-label"> <span
					class="x-red">*</span>所属类别
				</label>
				<input type="hidden" name="categoryParentId" value="${category.id }">
				<div class="layui-input-inline">
