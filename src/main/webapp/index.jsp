...
<body>
	...
	<div class="container">
		<div class="logo">
			<a href="index.jsp">L-admin v2.0</a>
		</div>
		<div class="left_open">
		...
		<div id="side-nav">
			<ul id="nav">
				...
				<li><a href="javascript:;"> <i class="iconfont">&#xe726;</i>
					...
					<ul class="sub-menu">
						<li><a _href="findAll.admin"> <i class="iconfont">&#xe6a7;</i>
								<cite>管理员列表</cite>
						</a></li>
				...
				<li><a href="javascript:;"> <i class="iconfont">&#xe6b8;</i>
					...
					<ul class="sub-menu">
						<li><a _href="findAll.user"> <i class="iconfont">&#xe6a7;</i>
								<cite>会员列表</cite>

						</a></li>
						<li><a _href="user_delete.jsp"> <i class="iconfont">&#xe6a7;</i>
								<cite>会员删除</cite>
						...
						<li><a href="javascript:;"> <i class="iconfont">&#xe70b;</i>
							...
							<ul class="sub-menu">
								<li><a _href="findAll.user"> <i
										class="iconfont">&#xe6a7;</i> <cite>会员列表</cite>

								</a></li>
								<li><a _href="user_delete.jsp"> <i
				...
				<li><a href="javascript:;"> <i class="iconfont">&#xe6ae;</i>
						<cite>类别管理</cite> <i class="iconfont nav_right">&#xe6a7;</i>
				</a>
					<ul class="sub-menu">
						<li><a _href="category_list.jsp"> <i class="iconfont">&#xe6a7;</i>
								<cite>类别列表</cite>
						</a></li>
					</ul></li>
				...
				<li><a href="javascript:;"> <i class="iconfont">&#xe6ae;</i>
					...
					<ul class="sub-menu">
						<li><a _href="findAll.product"> <i class="iconfont">&#xe6a7;</i>
								<cite>商品列表</cite>
						</a></li>
					</ul></li>
