...
<body class="layui-anim layui-anim-up">
	...
	<div class="x-body">
		...
		<button class="layui-btn"
			onclick="x_admin_show('添加用户','user_add.jsp',600,400)">
			...
			<tbody>
				<c:forEach items="${users }" var="user">
					<tr>
						...
						<td>${user.userAddr}</td>
						<td>${user.userRdate}</td>
						<td class="td-manage"><a title="编辑"
							onclick="x_admin_show('编辑','load.user?id=${user.id}',600,400)"
							href="javascript:;"> <i class="layui-icon">&#xe642;</i>
						</a> <a title="重置密码" href="userPasswordReset.admin?id=${user.id }"> <i class="layui-icon">&#xe631;</i>
